...
public class EditProfilePage<StorageReference> extends AppCompatActivity {
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        StorageReference storageReference1;storageReference1 = storageReference.child(filepathname);
