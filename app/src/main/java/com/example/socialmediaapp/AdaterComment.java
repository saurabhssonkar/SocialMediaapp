...
public class AdaterComment extends RecyclerView.Adapter<com.example.socialmediaapp.AdaterComment.MyHolder> {

    Context context;
    List<ModelComment> list;

    public AdaterComment(Context context, List<ModelComment> list, String myuid, String postid) {
